...
${email}            abcdefu@gmail.com
${first_name}       Acicah
${last_name}        Lestari
${password}         123456
${company_name}     PT. Mencari Cinta Sejati
${address_1}        Jalan in Aja Dulu Siapa Tau Cocok
${address_2}        RT. 009 RW. 010, Kec. Suka, Kel. Setia
${city}             Jakarta Selatan
${postal_code}      19901
${other_message}    hai semua, nama saya Acicah. saya sedang menginputkan field additional information
